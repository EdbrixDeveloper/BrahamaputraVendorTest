...
import com.brahamaputra.mahindra.brahamaputravendor.Data.AcPmAcData;
import com.brahamaputra.mahindra.brahamaputravendor.Data.AcPmTransactionDetails;
import com.brahamaputra.mahindra.brahamaputravendor.Data.AcPreventiveMaintanceProcessDatum;
import com.brahamaputra.mahindra.brahamaputravendor.Data.AcPreventiveMaintanceProcessParentDatum;
...
public class PreventiveMaintenanceAcTechnicianActivity extends BaseActivity {
    ...
    private void submitDetails(int i) {
        ...
        try {
            ...
            acPmTransactionDetails.setVendorId(sessionManager.getSessionVendorId());
    ...
    private void displayDataOnForm(Intent intent) {
        ...
        acTechnicianName = "";
        intent.getStringExtra("acTechnicianName");
    ...
    private void GetScannedAcQrData() {
        try {
            ...
            Log.i(PreventiveMaintenanceAcTechnicianActivity.class.getName(), Constants.acPmVendorAcDataOnQrCodeScan + "\n\n" + jo.toString());

            GsonRequest<AcPmAcData> getScannedQrCodeAcData = new GsonRequest<>(Request.Method.POST, Constants.acPmVendorAcDataOnQrCodeScan, jo.toString(), AcPmAcData.class,
        ...
        try {
            if (offlineStorageWrapper.checkOfflineFileIsAvailable(GlobalMethods.replaceAllSpecialCharAtUnderscore(ticketName) + ".txt")) {
                ...
                GsonRequest<UserLoginResponseData>
                        submitSitePmTicketRequest = new GsonRequest<>(Request.Method.POST, Constants.processedVendorAcPmTicket, jsonInString, UserLoginResponseData.class,
