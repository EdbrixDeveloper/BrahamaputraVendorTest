    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray array = getContext().obtainStyledAttributes(attrs,
                    com.brahamaputra.mahindra.brahamaputravendor.R.styleable.CircleImageView);

            this.name = array.getString(com.brahamaputra.mahindra.brahamaputravendor.R.styleable.CircleImageView_name);
            array.recycle();
        }
    }
